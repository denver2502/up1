...
Процедура ПечатнаяФорма(ТабличныйДокумент) Экспорт
	...
	Если Не ВариантыПростойПрописиСуммыПоТоварам.Количество() = 0 Тогда
		СуммаПоТоварамПрописью = СуммаПоТоварамПрописью + ВариантыПростойПрописиСуммыПоТоварам[0];
	КонецЕсли;	
	...
	Если Не ВариантыСложнойПрописиСуммыПоТоварам.Количество() = 0 Тогда
		СуммаПоТоварамПрописью = СуммаПоТоварамПрописью + " " + "(" + ВариантыСложнойПрописиСуммыПоТоварам[0] + ")";
	КонецЕсли;
	...
	Если Не ПустаяСтрока(СуммаПоТоварамПрописью) Тогда
		Шапка.Параметры.СуммаПоТоварам = СуммаПоТоварамПрописью;
	Иначе
